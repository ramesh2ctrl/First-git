...
$today = Get-Date(Get-Date).ToUniversalTime()
...
$script:wsus = [Microsoft.UpdateServices.Administration.AdminProxy]::getUpdateServer("${Script:WSUS_SERVER}", $True, "${Script:WSUS_PORT}")
